...
class SignInWithPhoneNumberView: UIView {
    ...
    func configure(with viewModel: SignInWithPhoneNumberViewModel) {
    ...
    private func setupCountryButton() {
        ...
        NSLayoutConstraint.activate([
            signInCountryButton.leadingAnchor.constraint(equalTo: signInContentView.leadingAnchor, constant: CONTENTCORNERRADIUS / 2),
